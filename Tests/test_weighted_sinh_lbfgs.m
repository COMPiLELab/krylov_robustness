% Test the performances of the interior point scheme incorporating the L-BFGS approximation of the Hessian for the tuning, rewire, and addition problems on power grid graphs with f=sinh
...
for i = 1 : length(Countries)
    ...
    for hkl = 1 : length(methods)
        ...
        filepath = sprintf('../Results/results_weighted_sinh_lbfgs_%s.csv', string(date));
...
dlmwrite('../Results/results_weighted_sinh_lbfgs_score.dat', data, '\t');
dlmwrite('../Results/results_weighted_sinh_lbfgs_time.dat', data_time, '\t');
dlmwrite('../Results/results_weighted_sinh_lbfgs_it.dat', data_it, '\t');
