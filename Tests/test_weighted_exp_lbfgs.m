% Test the performances of the interior point scheme with l-bfgs Hessian approximation for the tuning, rewire, and addition problems on power grid graphs
...
for i = 1 : length(Countries)
    ...
    for hkl = 1 : length(methods)
        ...
        filepath = sprintf('../Results/results_weighted_exp_lbfgs_%s.csv', string(date));
...
dlmwrite('../Results/results_weighted_exp_lbfgs_score.dat', data, '\t');
dlmwrite('../Results/results_weighted_exp_lbfgs_time.dat', data_time, '\t');
dlmwrite('../Results/results_weighted_exp_lbfgs_it.dat', data_it, '\t');
